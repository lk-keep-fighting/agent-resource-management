...
### Phase 1: 基础架构
- [ ] 1.1 创建项目目录结构
- [ ] 1.2 定义共享类型 (pkg/types)
- [ ] 1.3 设计 MySQL 表结构
- [ ] 1.4 配置数据库连接

### Phase 2: Backend API
- [ ] 2.1 实现 API 响应封装
- [ ] 2.2 实现 API Key 认证中间件
- [ ] 2.3 POST /api/v1/auth/login 登录接口
- [ ] 2.4 GET /api/v1/auth/me 获取当前用户
- [ ] 2.5 GET /api/v1/skills 列表/搜索 Skills
- [ ] 2.6 GET /api/v1/skills/:name 获取 Skill 详情
- [ ] 2.7 GET /api/v1/skills/:name/download 下载 Skill ZIP
- [ ] 2.8 POST /api/v1/skills 上传/发布 Skill
- [ ] 2.9 DELETE /api/v1/skills/:name 删除 Skill
- [ ] 2.10 GET /api/v1/users/me/skills 我的发布列表
- [ ] 2.11 GET /api/v1/health 健康检查

### Phase 3: Web UI
- [ ] 3.1 搭建 Next.js + shadcn/ui 项目
- [ ] 3.2 登录页 (API Key 登录)
- [ ] 3.3 布局 (侧边栏 + 导航)
- [ ] 3.4 Skill 市场列表页
- [ ] 3.5 Skill 详情页 (下载按钮)
...
- [ ] 4.3 adk login 登录命令
- [ ] 4.4 adk logout 登出命令
- [ ] 4.5 adk skill ls 列出 Skills
- [ ] 4.6 adk skill search 搜索 Skills
- [ ] 4.7 adk skill info 查看详情
- [ ] 4.8 adk skill download 下载并解压
- [ ] 4.9 adk skill upload 上传 ZIP
- [ ] 4.10 adk skill my 我的发布
- [ ] 4.11 adk skill delete 删除
- [ ] 4.12 adk skill validate 验证格式

### Phase 5: 完善
- [ ] 5.1 ZIP 包格式验证
- [ ] 5.2 SKILL.md frontmatter 验证
- [ ] 5.3 错误处理规范化
- [ ] 5.4 日志记录
- [ ] 5.5 配置管理 (.adkrc)
